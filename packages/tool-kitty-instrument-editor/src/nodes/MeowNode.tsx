...
export class MeowNodeType implements NodeType<NodeTypeExt,NodeExt,MeowState> {
  componentType = meowComponentType;
  ext: NodeTypeExt;

  constructor() {
    this.ext = {
      initAudioCtx: async (audioCtx, workletNode) => {
        const presetIndex = 0;
...
class MeowNode implements Node<NodeTypeExt,NodeExt,MeowState> {
  type = meowNodeType;
